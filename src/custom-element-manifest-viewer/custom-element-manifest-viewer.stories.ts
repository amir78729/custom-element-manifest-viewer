...
const Template: Story<ArgTypes> = ({ tagName}) => html`
  <custom-element-manifest-viewer tag-name=${tagName} src='../custom-element-manifest-viewer/sample/sample-custom-elements.json'>
...
const Slots: Story<ArgTypes> = ({ tagName}) => html`
  <custom-element-manifest-viewer tag-name='tap-row' src='../custom-element-manifest-viewer/sample/sample-custom-elements.json'>
